...
#%%
    ...
    # cyt_msk = data["cyt_msk"]
    # ncl_msk = data["ncl_msk"]
    # C1 = data["htk"][:, 0, ...]
    # C2 = data["htk"][:, 1, ...]
    # C3 = data["htk"][:, 2, ...]
    ...
    # # Get blobs
    # C1_lbl, C1_prp = get_blobs(
    #     data["htk"][:, 0, ...], mask=cyt_msk, 
    #     sigma0=sigma0, sigma1=sigma1, 
    #     thresh_coeff=2,
    #     out_prp=True
    #     )
    # C2_lbl, C2_prp = get_blobs(
    #     data["htk"][:, 1, ...], mask=cyt_msk, 
    #     sigma0=sigma0, sigma1=sigma1, 
    #     thresh_coeff=2,
    #     out_prp=True
    #     )
    # C3_lbl, C3_prp = get_blobs(
    #     data["htk"][:, 2, ...], mask=cyt_msk, 
    #     sigma0=sigma0, sigma1=sigma1, 
    #     thresh_coeff=2,
    #     out_prp=True
    #     )
...
#%%
    ...
    # if chn == 0:
    #     viewer.add_image(data["htk"][:, 0, ...])
    #     viewer.add_image(C1_prp, blending="additive", opacity=0.5)
    #     viewer.add_labels(C1_lbl)
    # if chn == 1:
    #     viewer.add_image(data["htk"][:, 1, ...])
    #     viewer.add_image(C2_prp, blending="additive", opacity=0.5)
    #     viewer.add_labels(C2_lbl)
    # if chn == 2:
    #     viewer.add_image(data["htk"][:, 2, ...])
    #     viewer.add_image(C3_prp, blending="additive", opacity=0.5)
    #     viewer.add_labels(C3_lbl)
